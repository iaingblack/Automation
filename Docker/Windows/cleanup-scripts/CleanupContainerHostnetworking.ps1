...
#From here - https://github.com/Microsoft/Virtualization-Documentation/blob/master/windows-server-container-tools/CleanupContainerHostNetworking/CleanupContainerHostNetworking.ps1
